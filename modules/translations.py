...
TRANSLATIONS: dict[str, dict[str, str]] = {
    "nl": {
        ...
        "test_check_all": "Alle projecten nakijken",
        "test_part_failed": "{name} is gestruikeld - zie het logboek. De andere onderdelen staan er wel.",
        "test_check_all_hint": "Vijf rapporten over je liedjes in één keer: wat meetbaar is, de drie goedkope projectrapporten, wat wel gehoord is maar niet in de songtekst staat, de meetlat tegen je handmatige timing, en de woord- en lettergreepcontroles. Leest alleen bestanden die er al liggen; onder de minuut over alle projecten.",
        ...
        # --- report texts of the test panel (v1.0.11) ---
        "rep_yes": "ja",
        "rep_no": "NEE",
        "rep_col_project": "project",
        "rep_col_cache": "cache",
        "rep_col_timing": "timing",
        "rep_col_lines": "regels",
        "rep_col_auto_version": "auto-versie",
        "rep_col_words": "woorden",
        "rep_col_loop": "lus",
        "rep_col_boundary": "grens",
        "rep_col_phantom": "spook",
        "rep_col_period": "periode",
        "rep_col_anchors": "ankers",
        "rep_col_sentences": "zinnen",
        "rep_col_gaps": "gaten",
        "rep_kind_repetition": "herhaling",
        "rep_kind_unknown": "onbekend",
        "rep_line": "regel",
        "rep_col_coupled_short": "gekop.",
        "rep_col_moved": "verzet",
        "rep_col_error_moved": "fout verzet",
        "rep_col_error_rest": "fout rest",
        "rep_col_syllables_short": "lettergr.",
        "rep_col_shape": "vorm",
        "rep_col_silence": "stilte",
        "rep_col_between": "tussen",
        "rep_col_duration": "duur",
        "rep_col_onset": "inzet",
        "rep_col_repeat": "herhaal",
        "rep_col_unique": "uniek",
        "rep_col_repeated": "herhaald",
        "rep_col_variant": "variant",
        "rep_col_error": "fout",
        "rep_col_difference": "verschil",
        "rep_baseline": "uitgangspunt",
        "rep_matrix_title": "Modelmatrix",
        "rep_head_baseline": "Uitgangspunt",
        "rep_matrix_weighted": "gewogen fout: **{error:.2f} s**",
        "rep_matrix_damage": "schade op ongemoeide regels: {damage:.2f} s",
        "rep_matrix_project_cols": "| project | fout |",
        "rep_head_singles": "Elk model apart anders",
        "rep_matrix_singles_cols": "| niveau | model | stand | fout | verschil | schade |",
        "rep_head_where": "Waar komt elk model tot zijn recht",
        "rep_matrix_where_cols": "| model | grootste winst | grootste verlies |",
        "rep_head_pairs": "Twee tegelijk anders",
        "rep_matrix_pairs_cols": "| model A | model B | samen | los opgeteld | verschil |",
        "rep_head_order": "Volgorde",
        "rep_matrix_order_cols": "| volgorde | fout | verschil |",
        "rep_head_coupling": "Woordkoppeling (dekking)",
        "rep_matrix_coupling_cols": "| variant | project | woorden | gekoppeld | meervoudig | zwak | zwak% | laagste | energie | gat | gefilterd | vulwoord | geen match |",
        "rep_head_words": "Woord en lettergreep",
        "rep_matrix_words_cols": "| variant | project | regels | woorden | lettergrepen | vorm | zonder duur | in stilte | afstand tot inzet | herhaalverschil |",
        "rep_alarm_cols": "| project | anders gezet | wat er mis is |",
        "rep_cluster_measured_on": "gemeten op {count} project(en) met handmatige timing",
        "rep_cluster_baseline": "uitgangspunt: **{error:.2f} s**",
        "rep_cluster_head": "Cluster {number}: {count} modellen",
        "rep_cluster_cols": "| combinatie (anders gezet) | fout | verschil |",
        "rep_n_of_m": "{done} van {total}",
        "rep_climb": "klim {step}: {name}",
        "rep_search_baseline_search": "uitgangspunt zoekset: **{error:.2f} s**",
        "rep_search_baseline_held": "uitgangspunt achtergehouden: **{error:.2f} s**",
        "rep_search_cols": "| start | gevonden combinatie | zoekset | achtergehouden | metingen |",
        "rep_search_start_current": "huidige stand",
        "rep_search_start_random": "willekeurig {number}",
        "rep_chunk_cols": "| variant | segmenten | woorden | in tekst | niet gehoord | gevuld | rekentijd |",
        "rep_chunk_run_current": "huidig",
        "rep_chunk_run_offset_10": "offset 10 s",
        "rep_chunk_run_offset_20": "offset 20 s",
        "rep_chunk_run_chunked": "knippen",
        "rep_chunk_run_chunked_global": "knippen (globale prompt)",
        "rep_chunk_run_chunked_vad": "knippen + vad",
        "rep_chunk_pieces": "{name} ({count} stukken)",
        "rep_chunk_merged_base": "samengevoegd (basis: {name})",
        "rep_chunk_merged": "samengevoegd",
        "rep_words_count": "{name} ({count} woorden)",
        "rep_gain_as_is": "zoals nu",
        "rep_gain_cols": "| niveau | woorden | in tekst | niet gehoord | rekentijd |",
        "rep_col_outcome": "uitkomst",
        "rep_col_old": "oud",
        "rep_col_remarks": "bijzonderheden",
        "rep_outcome_skipped": "overgeslagen",
        "rep_outcome_failed": "MISLUKT",
        "rep_outcome_new": "nieuw",
        "rep_uncoupled_cols": "| woord | keer | lengte |",
        "rep_held_cols": "| duur | project | regel | lettergreep |",
        "rep_blocks_cols": "| spreiding | project | keer | mediaan | blok |",
        "rep_combinations_title": "Modelcombinaties",
        # --- report texts: cluster, lyrics, model register, yardstick (v1.0.11) ---
        "cluster_rep_heading": "Cluster {id}",
        "cluster_rep_count": "({count}x)",
        "cluster_rep_more_spellings": "  ... en {count} andere spellingen",
        "cluster_rep_summary": (
            "  gevonden: {frequency} keer, confidence {confidence:.2f}, duur {duration:.2f} s, pauze {pause:.1f} s"),
        "cluster_rep_more_clusters": "... en {count} kleinere clusters (zie clusters.csv)",
        "lyrics_rep_not_coupled": "(niet gekoppeld)",
        "model_name_b250_b251": "blokgrens",
        "model_name_b329_332_340": "ankertoets",
        "model_name_b332": "frase-periode",
        "model_name_b329": "referentieduur",
        "model_name_b330_b351": "snappen",
        "model_name_b351": "begin na pauze",
        "model_name_b336": "staartvensters",
        "model_name_b334": "herhaallus",
        "model_name_b342": "grenswoorden",
        "model_name_b343": "spookwoorden",
        "model_name_b377": "zang als scheidsrechter",
        "model_name_b258_b285": "hallucinaties",
        "model_name_b307_b337": "hallucinaties op plek",
        "model_name_b213": "vulwoorden apart",
        "model_name_b276": "vulwoord-voorrang",
        "model_name_b159": "zwakke staart losmaken",
        "model_name_b121": "handkoppelingen",
        "model_name_b313": "energieplaatsing",
        "model_name_b392": "gat op de zang",
        "model_name_b380": "sjabloontiming",
        "model_name_b234_b347": "woorden op de zangvensters",
        "model_name_b241": "fonetische lettergrepen",
        "model_name_b191": "koppeling uitbreiden",
        "model_name_b228": "creatieve koppelingen",
        # --- the start script, and words spliced into log lines (v1.0.11) ---
        "log_logging_started": "Logging gestart: %s",
        "value_restored": "hersteld",
        "value_default": "standaard",
        "value_one_to_one": "1-op-1",
        "value_per_block": "per blok",
        "value_proportional": "evenredig",
        "log_uncaught_crash": "Onafgevangen fout (crash)",
        "log_app_started": "KaraokeTool versie %s gestart",
        "log_default_config_created": "Standaardconfiguratie aangemaakt: %s",
        "log_config_unreadable": "Configuratie kon niet worden geladen",
        "console_config_error": "Fout in de configuratie ({path}); zie het logbestand.",
        "log_models_state": "Modellen: %s",
        "console_models_off": "Let op: {count} model(len) staan uit: {names}",
        "log_ffmpeg_not_on_path": "ffmpeg/ffprobe niet gevonden in PATH",
        "console_ffmpeg_missing": "Waarschuwing: ffmpeg/ffprobe niet gevonden. Installeer ffmpeg (zie README.md).",
        "log_pyside_missing": "PySide6 niet beschikbaar",
        "console_pyside_missing": "PySide6 is niet geïnstalleerd; draai install.bat opnieuw.",
        "log_app_closed": "KaraokeTool afgesloten",
        "console_interrupted": "Afgebroken door gebruiker.",
        "log_unexpected_error": "Onverwachte fout",
        "console_unexpected_error": "Onverwachte fout; zie het logbestand in de map 'logs'.",
        "paths_song_mismatch": "paden.song='{song}' != titel='{title}'",
        "paths_deviate": "Projectpaden wijken af: {details}",
        "paths_consistent": "Projectpaden consistent voor '{title}'.",
        "paths_no_title": "(geen titel)",
        "value_unknown_error": "onbekende fout",
        # --- listening again (v1.0.12) ---
        "log_gap_text_added": "Bekende tekst op %d ongehoord gezongen stuk(ken) gelegd (%d woorden)",
        "log_gap_text_failed": "Bekende tekst op de zang leggen mislukt; de transcriptie blijft zoals hij is",
        "err_listen_again_no_vocals": "Opnieuw horen heeft de zangstem nodig; draai eerst '{step_detect}' met Demucs aan.",
        "log_listen_again_areas": "Opnieuw horen: %d probleemplek(ken)",
        "log_listen_again_failed": "Opnieuw horen op %.1f-%.1f s mislukt",
        "log_heard_again_saved": "Opnieuw gehoord: %d stuk(ken) opgeslagen",
        "log_heard_again_cleared": "Eerder opnieuw gehoorde stukken gewist",
        "couple_listen_again": "Opnieuw horen...",
        "couple_listen_again_tip": "Laat elke ontbrekende of zwak gekoppelde plek opnieuw horen: Whisper op alleen dat stuk, en de bekende tekst op de zang gelegd, met de zangstem als scheidsrechter. Goede en handmatige koppelingen blijven staan. Je kiest daarna per plek wat je overneemt.",
        "listen_again_busy": "Opnieuw horen (Whisper per plek; dit kan even duren)...",
        "listen_again_nothing": "Geen ontbrekende of zwak gekoppelde plekken gevonden.",
        "listen_again_title": "Opnieuw horen",
        "listen_again_intro": "Per plek staat de beste kandidaat voorop. Vink aan wat je wilt overnemen; de rest blijft zoals het is en komt bij een volgende keer opnieuw aan bod.",
        "listen_again_col_take": "Overnemen",
        "listen_again_col_where": "Waar",
        "listen_again_col_expected": "Verwacht",
        "listen_again_col_candidate": "Kandidaat",
        "listen_again_where": "{low:.1f}–{high:.1f} s",
        "listen_again_kind_whisper": "opnieuw gehoord",
        "listen_again_kind_aligned": "uitgelijnd",
        "listen_again_candidate": "{kind} ({score:.2f}): {text}",
        "listen_again_none": "(niets gevonden)",
        "listen_again_evidence": "Overeenkomst {evidence:.2f} · op zang {singing:.2f} · ritme {rhythm:.2f}{echo}",
        "listen_again_echo": " · lijkt de hint na te zeggen",
        "listen_again_apply": "Overnemen",
        "listen_again_clear": "Eerder opnieuw gehoorde stukken wissen",
        "listen_again_saved": "{count} stuk(ken) overgenomen; zinkoppeling en timing moeten opnieuw gemaakt worden.",
        "listen_again_cleared": "Eerder opnieuw gehoorde stukken gewist.",
        "legend_heard_again": "opnieuw gehoord",
        "legend_aligned": "uitgelijnd op de zang",
        "model_order_before": "vóór",
        "model_level_blok": "blok",
        "model_level_zin": "zin",
        "model_level_koppeling": "koppeling",
        "model_level_woord": "woord",
        "model_level_venster": "venster",
        "model_reason_b258_b285": (
            "-0,14 s op de ijkset; op Lied_T 17,29 s tegen 7,28 s"),
        "model_reason_b392": (
            "een gat middenin kreeg een rechte lijn; {b336} deed dit al voor de staart"),
        "model_reason_b380": (
            "bouwt sjablonen uit de koppeluitvoer; op een stukke outro levert dat een ondergrens van 1.00 s op"),
        "model_state_count": "{on} aan, {off} uit",
        "model_state_off_codes": " (uit: {codes})",
        "yard_header": (
            "# Meetlat: koppeling en timing per versie\n"
            "\n"
            ...
            "en laat daarbij alle handmatige correcties weg ({finding}): de opgeslagen\n"
            ...
            "\n"),
        "yard_table_head": (
            "| project | zinnen | gekoppeld | verzet | fout op verzette regels |"),
        "yard_weighted": "Gewogen over {count} verzette regels: **{average:.2f} s**.",
    },
    "en": {
        "app_title": "Karaoke Tool",
        ...
        "test_check_all": "Check all projects",
        "test_part_failed": "{name} stumbled - see the log. The other parts are here.",
        "test_check_all_hint": "Five reports about your songs in one go: what is measurable, the three cheap project reports, what was heard but is not in the lyrics, the yardstick against your hand-made timing, and the word and syllable checks. Reads only files that are lying there anyway; under a minute over all projects.",
        ...
        "rep_col_timing": "timing",
        "rep_col_lines": "lines",
        "rep_col_auto_version": "auto version",
        "rep_col_words": "words",
        "rep_col_loop": "loop",
        "rep_col_boundary": "edge",
        "rep_col_phantom": "ghost",
        "rep_col_period": "period",
        "rep_col_anchors": "anchors",
        "rep_col_sentences": "sent.",
        "rep_col_gaps": "gaps",
        "rep_kind_repetition": "repeated",
        "rep_kind_unknown": "unknown",
        "rep_line": "line",
        "rep_col_coupled_short": "coupl.",
        "rep_col_moved": "moved",
        "rep_col_error_moved": "error moved",
        "rep_col_error_rest": "error rest",
        "rep_col_syllables_short": "syllables",
        "rep_col_shape": "shape",
        "rep_col_silence": "silent",
        "rep_col_between": "betw.",
        "rep_col_duration": "span",
        "rep_col_onset": "onset",
        "rep_col_repeat": "repeat",
        "rep_col_unique": "unique",
        "rep_col_repeated": "repeated",
        "rep_col_variant": "variant",
        "rep_col_error": "error",
        "rep_col_difference": "change",
        "rep_baseline": "baseline",
        "rep_matrix_title": "Model matrix",
        "rep_head_baseline": "Baseline",
        "rep_matrix_weighted": "weighted error: **{error:.2f} s**",
        "rep_matrix_damage": "damage on untouched lines: {damage:.2f} s",
        "rep_matrix_project_cols": "| project | error |",
        "rep_head_singles": "Each model set differently on its own",
        "rep_matrix_singles_cols": "| level | model | state | error | difference | damage |",
        "rep_head_where": "Where each model comes into its own",
        "rep_matrix_where_cols": "| model | biggest gain | biggest loss |",
        "rep_head_pairs": "Two set differently at once",
        "rep_matrix_pairs_cols": "| model A | model B | together | added up separately | difference |",
        "rep_head_order": "Order",
        "rep_matrix_order_cols": "| order | error | difference |",
        "rep_head_coupling": "Word coupling (coverage)",
        "rep_matrix_coupling_cols": "| variant | project | words | coupled | multiple | weak | weak% | lowest | energy | gap | filtered | filler | no match |",
        "rep_head_words": "Word and syllable",
        "rep_matrix_words_cols": "| variant | project | lines | words | syllables | shape | without duration | in silence | distance to onset | repeat difference |",
        "rep_alarm_cols": "| project | set differently | what is wrong |",
        "rep_cluster_measured_on": "measured on {count} project(s) with hand-made timing",
        "rep_cluster_baseline": "baseline: **{error:.2f} s**",
        "rep_cluster_head": "Cluster {number}: {count} models",
        "rep_cluster_cols": "| combination (set differently) | error | difference |",
        "rep_n_of_m": "{done} of {total}",
        "rep_climb": "climb {step}: {name}",
        "rep_search_baseline_search": "baseline search set: **{error:.2f} s**",
        "rep_search_baseline_held": "baseline held out: **{error:.2f} s**",
        "rep_search_cols": "| start | combination found | search set | held out | measurements |",
        "rep_search_start_current": "current state",
        "rep_search_start_random": "random {number}",
        "rep_chunk_cols": "| variant | segments | words | in text | not heard | filled | compute time |",
        "rep_chunk_run_current": "current",
        "rep_chunk_run_offset_10": "offset 10 s",
        "rep_chunk_run_offset_20": "offset 20 s",
        "rep_chunk_run_chunked": "chunked",
        "rep_chunk_run_chunked_global": "chunked (global prompt)",
        "rep_chunk_run_chunked_vad": "chunked + vad",
        "rep_chunk_pieces": "{name} ({count} pieces)",
        "rep_chunk_merged_base": "merged (base: {name})",
        "rep_chunk_merged": "merged",
        "rep_words_count": "{name} ({count} words)",
        "rep_gain_as_is": "as it is",
        "rep_gain_cols": "| level | words | in text | not heard | compute time |",
        "rep_col_outcome": "outcome",
        "rep_col_old": "old",
        "rep_col_remarks": "notes",
        "rep_outcome_skipped": "skipped",
        "rep_outcome_failed": "FAILED",
        "rep_outcome_new": "new",
        "rep_uncoupled_cols": "| word | times | length |",
        "rep_held_cols": "| duration | project | line | syllable |",
        "rep_blocks_cols": "| spread | project | times | median | block |",
        "rep_combinations_title": "Model combinations",
        # --- report texts: cluster, lyrics, model register, yardstick (v1.0.11) ---
        "cluster_rep_heading": "Cluster {id}",
        "cluster_rep_count": "({count}x)",
        "cluster_rep_more_spellings": "  ... and {count} other spellings",
        "cluster_rep_summary": (
            "  occurrences: {frequency}, confidence {confidence:.2f}, duration {duration:.2f} s, pause {pause:.1f} s"),
        "cluster_rep_more_clusters": "... and {count} smaller clusters (see clusters.csv)",
        "lyrics_rep_not_coupled": "(not coupled)",
        "model_name_b250_b251": "block boundary",
        "model_name_b329_332_340": "anchor check",
        "model_name_b332": "phrase period",
        "model_name_b329": "reference duration",
        "model_name_b330_b351": "snapping",
        "model_name_b351": "start after a pause",
        "model_name_b336": "tail windows",
        "model_name_b334": "repetition loop",
        "model_name_b342": "boundary words",
        "model_name_b343": "phantom words",
        "model_name_b377": "vocals as referee",
        "model_name_b258_b285": "hallucinations",
        "model_name_b307_b337": "hallucinations in place",
        "model_name_b213": "filler words separately",
        "model_name_b276": "filler-word priority",
        "model_name_b159": "detach weak tail",
        "model_name_b121": "manual couplings",
        "model_name_b313": "energy placement",
        "model_name_b392": "gap on the vocals",
        "model_name_b380": "template timing",
        "model_name_b234_b347": "words on the vocal windows",
        "model_name_b241": "phonetic syllables",
        "model_name_b191": "extend coupling",
        "model_name_b228": "creative couplings",
        # --- the start script, and words spliced into log lines (v1.0.11) ---
        "log_logging_started": "Logging started: %s",
        "value_restored": "restored",
        "value_default": "default",
        "value_one_to_one": "1-to-1",
        "value_per_block": "per block",
        "value_proportional": "proportional",
        "log_uncaught_crash": "Uncaught error (crash)",
        "log_app_started": "KaraokeTool version %s started",
        "log_default_config_created": "Default configuration created: %s",
        "log_config_unreadable": "The configuration could not be loaded",
        "console_config_error": "Error in the configuration ({path}); see the log file.",
        "log_models_state": "Models: %s",
        "console_models_off": "Note: {count} model(s) are switched off: {names}",
        "log_ffmpeg_not_on_path": "ffmpeg/ffprobe not found on PATH",
        "console_ffmpeg_missing": "Warning: ffmpeg/ffprobe not found. Install ffmpeg (see README.md).",
        "log_pyside_missing": "PySide6 not available",
        "console_pyside_missing": "PySide6 is not installed; run install.bat again.",
        "log_app_closed": "KaraokeTool closed",
        "console_interrupted": "Interrupted by the user.",
        "log_unexpected_error": "Unexpected error",
        "console_unexpected_error": "Unexpected error; see the log file in the 'logs' folder.",
        "paths_song_mismatch": "paths.song='{song}' != title='{title}'",
        "paths_deviate": "Project paths deviate: {details}",
        "paths_consistent": "Project paths consistent for '{title}'.",
        "paths_no_title": "(no title)",
        "value_unknown_error": "unknown error",
        # --- listening again (v1.0.12) ---
        "log_gap_text_added": "Known lyrics laid on %d unheard sung stretch(es) (%d words)",
        "log_gap_text_failed": "Laying the known lyrics on the singing failed; the transcription stays as it is",
        "err_listen_again_no_vocals": "Listening again needs the vocal stem; run '{step_detect}' with Demucs switched on first.",
        "log_listen_again_areas": "Listening again: %d problem area(s)",
        "log_listen_again_failed": "Listening again at %.1f-%.1f s failed",
        "log_heard_again_saved": "Heard again: %d stretch(es) saved",
        "log_heard_again_cleared": "Earlier heard-again stretches cleared",
        "couple_listen_again": "Listen again...",
        "couple_listen_again_tip": "Listen again at every missing or weakly coupled place: Whisper on only that stretch, and the known lyrics laid on the singing, with the vocal stem as referee. Good and manual couplings stay as they are. Afterwards you choose per place what to take over.",
        "listen_again_busy": "Listening again (Whisper per place; this can take a while)...",
        "listen_again_nothing": "No missing or weakly coupled places found.",
        "listen_again_title": "Listen again",
        "listen_again_intro": "Per place the best candidate comes first. Tick what you want to take over; the rest stays as it is and comes up again next time.",
        "listen_again_col_take": "Take",
        "listen_again_col_where": "Where",
        "listen_again_col_expected": "Expected",
        "listen_again_col_candidate": "Candidate",
        "listen_again_where": "{low:.1f}–{high:.1f} s",
        "listen_again_kind_whisper": "heard again",
        "listen_again_kind_aligned": "aligned",
        "listen_again_candidate": "{kind} ({score:.2f}): {text}",
        "listen_again_none": "(nothing found)",
        "listen_again_evidence": "Match {evidence:.2f} · on singing {singing:.2f} · rhythm {rhythm:.2f}{echo}",
        "listen_again_echo": " · seems to read back the hint",
        "listen_again_apply": "Take over",
        "listen_again_clear": "Clear earlier heard-again stretches",
        "listen_again_saved": "{count} stretch(es) taken over; the line coupling and the timing have to be made again.",
        "listen_again_cleared": "Earlier heard-again stretches cleared.",
        "legend_heard_again": "heard again",
        "legend_aligned": "aligned on the singing",
        "model_order_before": "before",
        "model_level_blok": "block",
        "model_level_zin": "line",
        "model_level_koppeling": "coupling",
        "model_level_woord": "word",
        "model_level_venster": "window",
        "model_reason_b258_b285": (
            "-0.14 s on the benchmark set; on Lied_T 17.29 s against 7.28 s"),
        "model_reason_b392": (
            "a gap in the middle got a straight line; {b336} already did this for the tail"),
        "model_reason_b380": (
            "builds templates from the coupling output; on a broken outro that gives a floor of 1.00 s"),
        "model_state_count": "{on} on, {off} off",
        "model_state_off_codes": " (off: {codes})",
        "yard_header": (
            "# Yardstick: coupling and timing per version\n"
            "\n"
            "The user corrects `timing.json` by hand in the waveform editor, while\n"
            "`timing_auto.json` keeps the automatic result. Every line he has moved\n"
            "is a line the automatic placement got wrong. This file keeps track, per\n"
            "version, of how far the automatic placement is still off.\n"
            "\n"
            "**Lines** is the number of karaoke lines, **coupled** how many of them\n"
            "got a really measured time from the transcription (that is the outcome\n"
            "of the coupling), **moved** how many lines the user still moved by hand\n"
            "after that, and **error on moved lines** how far the code is from his\n"
            "manual time on exactly those lines.\n"
            "\n"
            "The tool runs the real pipeline over the stored transcription and leaves\n"
            "out every manual correction while doing so ({finding}): the stored coupling\n"
            "contains the user's corrections on the original lane, and measuring\n"
            "against that flatters the result. The number of moved lines is fixed in\n"
            "the project and does not move along: it is the list of places where the\n"
            "tool got it wrong at the time, and it stays the touchstone.\n"
            "\n"
            "To update: `python tools/timing_regression.py <output-dir> --record`.\n"
            "\n"),
        "yard_table_head": (
            "| project | lines | coupled | moved | error on moved lines |"),
        "yard_weighted": "Weighted over {count} moved line(s): **{average:.2f} s**.",
    },
}
